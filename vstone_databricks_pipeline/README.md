# vstone_databricks_pipeline

The 'vstone_databricks_pipeline' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/vstone_databricks_pipeline/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] vstone_databricks_pipeline_etl` to your workspace.
